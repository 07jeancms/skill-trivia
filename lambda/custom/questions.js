module.exports = {
  ...
  QUESTIONS_ES_ES: [
    ...
    {
      'Como se llama el hermano de Jean Carlo? ': [
        'Carlos',
        'Manuel',
        'Maikol',
        'German',
    ...
    {
      'Como se llama el hermano de Jean Carlo 2? ': [
        'Carlos',
        'Manuel',
        'Maikol',
        'German',
    ...
    {
      'Como se llama el hermano de Jean Carlo 3? ': [
        'Carlos',
        'Manuel',
        'Maikol',
        'German',
    ...
    {
      'Como se llama el hermano de Jean Carlo 4? ': [
        'Carlos',
        'Manuel',
        'Maikol',
        'German',
    ...
    {
      'Como se llama el hermano de Jean Carlo 5? ': [
        'Carlos',
        'Manuel',
        'Maikol',
        'German',
