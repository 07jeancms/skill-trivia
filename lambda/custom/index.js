...
const languageString = {
  ...
  'es-ES': {
    translation: {
      ...
      GAME_NAME: 'Trivia',
      HELP_MESSAGE: 'Te haré %s preguntas de opción múltiple. Responde con el número de la respuesta. Por ejemplo, digamos uno, dos, tres o cuatro. Para comenzar un nuevo juego en cualquier momento, digamos, iniciar juego.',
      REPEAT_QUESTION_MESSAGE: 'Para repetir la última pregunta, diga, repita.',
      ASK_MESSAGE_START: '¿Te gustaría empezar a jugar?',
      HELP_REPROMPT: 'Para dar una respuesta a una pregunta, responda con el número de la respuesta.',
      STOP_MESSAGE: '¿Te gustaría seguir jugando?',
      QUIT_MESSAGE: 'Adiós.',
      CANCEL_MESSAGE: 'Ok, juguemos de nuevo pronto.',
      NO_MESSAGE: 'Ok, jugaremos en otra oportunidad. Adiós!',
      TRIVIA_UNHANDLED: 'Intenta diciendo un número entre 1 y %s',
      HELP_UNHANDLED: 'Di sí para continuar o no para terminar el juego.',
      START_UNHANDLED: 'Di empezar para empezar un nuevo juego.',
      NEW_GAME_MESSAGE: 'Bienvenido a %s. ',
      WELCOME_MESSAGE: 'Te preguntaré %s preguntas, Intenta acertar tantas como puedas. Solo di el número de la respuesta. Comencemos. ',
      ANSWER_CORRECT_MESSAGE: 'correcto. ',
      ANSWER_WRONG_MESSAGE: 'incorrecto. ',
      CORRECT_ANSWER_MESSAGE: 'La respuesta correcta es %s: %s. ',
      ANSWER_IS_MESSAGE: 'La respuesta es ',
      TELL_QUESTION_MESSAGE: 'Preguntas %s. %s ',
      GAME_OVER_MESSAGE: 'Obtuviste %s de un total de %s preguntas correctas. Gracias por jugar!',
